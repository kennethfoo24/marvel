...
// Apply the user check middleware to all routes
router.use(checkUser);

// Handle avenger selection
router.get("/avenger/:name", async (req, res) => {
  const avengers = { 
...
router.get('/attackGKE', async (req, res) => {
  try {
...
router.post("/security-submit", (req, res) => {
